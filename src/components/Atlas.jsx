    ...
    <nav style={{
      ...
      {mo && <div style={{ background: scrolled ? "rgba(12,35,64,0.95)" : "rgba(12,35,64,0.97)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", borderTop: "1px solid rgba(255,255,255,0.08)", padding: "12px 24px" }}>
        ...
        <div style={{ paddingTop: 16, paddingBottom: 8, display: "flex", gap: 10 }}>
          ...
          <a href="#contacto" onClick={(e) => { e.preventDefault(); setMo(false); const el = document.getElementById('contacto'); if (el) { const top = el.getBoundingClientRect().top + window.scrollY - 140; window.scrollTo({ top, behavior: 'smooth' }); } else { window.location.href = '/#contacto'; } }} style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 16px", borderRadius: 50, background: "linear-gradient(135deg, #1b6fea, #00a6ff)", color: "#fff", fontSize: 15, fontWeight: 700, fontFamily: "'Fira Sans',sans-serif", textDecoration: "none" }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" /></svg>
            {t("nav.contacto.mobile")}
          </a>
        </div>
      </div>}
    </nav>
    ...
    >
      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            flexShrink: 0,
            borderTop: isMobile ? "1px solid #e5e7eb" : "1px solid #f3f4f6",
            background: "#fff",
            padding: isMobile ? "12px 18px" : "18px 26px 24px",
          }}>
